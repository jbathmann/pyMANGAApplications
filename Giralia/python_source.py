...
def evaporation(salinity):
    ...
    return -3.144 / year * 1000 * (
        .10 - salinity
    ) / .10  #https://researchlibrary.agric.wa.gov.au/cgi/viewcontent
...
file = open(
    "/home/bathmann/Dokumente/UFZ/code/pyMANGA/ProjectLib/ExampleSetups/ogs_example_setup/EXM_Jan-Jul_2019.txt"
)
t_base = 0
h_s = []
t_s = []
